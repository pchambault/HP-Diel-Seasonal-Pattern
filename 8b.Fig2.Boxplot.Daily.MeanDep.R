################################################
## FIG 2: plot boxplot meanDep vs months #######
...
(a / b) + plot_layout(heights = c(1,1.4),
                      width   = c(1,1))
ggsave(filename=paste0("./FIGURES/PAPER/Fig.2_boxplot_SameScale.pdf"),
       grid.arrange(a,b,ncol=1),
