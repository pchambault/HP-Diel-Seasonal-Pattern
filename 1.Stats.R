...
mean(daily$max_dep)  # 236 m
sd(daily$max_dep)    # 75 m
max(daily$max_dep)   # 450 m

mean(daily$mean_dep)  # 70 m
sd(daily$mean_dep)    # 29 m
max(daily$mean_dep)   # 225 m

nrow(daily[daily$mean_dep>100,]) / nrow(daily) * 100 # 17%
nrow(daily[daily$mean_dep>50,]) / nrow(daily) * 100  # 72%
