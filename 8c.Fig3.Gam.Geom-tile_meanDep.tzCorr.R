...
# panel c: GAM
################
ind_pred <- readRDS("./RDATA/3.GAM/Indiv-GAM_daylength_meandep_slope_intercept_all_tzCorr.rds")
pop_pred <- readRDS("./RDATA/3.GAM/Pop-GAM_daylength_meandep_slope_intercept_all_tzCorr.rds")
m <- readRDS("./RDATA/3.GAM/GAM_output_daylength_meandep_slope_intercept_all_tzCorr.rds")
...
((a / b) | c) + plot_layout(widths  = c(1.5, 1),
                            heights = c(1,2))
ggsave(filename=paste0("./FIGURES/PAPER/Fig.3_geom-tile_GAM_meandep_tzCorr.pdf"),
