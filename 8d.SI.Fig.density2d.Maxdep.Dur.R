########################################################
## SI FIG. : geom_hdr maxdep/dive duration           ###
...
ggsave(filename=paste0("./FIGURES/PAPER/MaxDep_Dur_geomHDR.pdf"),
...
ggsave(filename=paste0("./FIGURES/PAPER/MaxDep_Dur_HDR-point.pdf"),
       width=4,height=5,units="in",dpi=400,family="ArialMT")
